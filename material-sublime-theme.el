;;; material-sublime-theme.el --- A sublimely flavored material theme
...
;; Credit to xiaoDC for general code structure, and kristijanhusak
...
(deftheme material-sublime
  "a sublimely flavored material theme")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (header-color "#455A64")
       (subtle "#a7adba") ;; tree-row-hover-disclosure-button-control
       (selection "#455A64") ;; tab-control-dirty-tab-close-button
       (hl-line "#FFC107") ;; hgihlight line
       ...
       (green "#b5bd68") ;; complement tab-control-dirty-tab-close-button
       (aqua "#8abeb7") ;; lighter complement tab-control-dirty-tab-close-button
       (blue "#81a2be") ;; complement tab-control-dirty-tab-close-button
       (purple "#b294bb")
       (darkcyan "#005f5f")
       (darkblue "#00005f")
       (darkred "#5f0000")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground "#c5c8c6"))))
   ...
   `(font-lock-variable-name-face ((,class (:foreground ,"#c2c8d7"))))

   `(font-lock-warning-face ((,class (:weight bold :foreground ,red))))
   `(highlight-numbers-number ((,class (:foreground ,purple))))
   `(shadow ((,class (:foreground ,comment))))
   `(success ((,class (:foreground, green))))
   `(error ((,class (:foreground ,orange2))))
   ...
   `(highlight-indentation-current-column-face ((,class (:background, background))))
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground , orange2))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground , red))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground , pink))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground , lime))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground , yellow))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground , sky))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground , pink))))
   ...
   `(highlight ((,class (:inverse-video nil :background ,hl-line))))
   ...
   `(secondary-selection ((,class (:background ,secondary-selection))))
    ...
    `(header-line ((,class (:inherit mode-line :foreground ,"#4DB6AC" :background nil))))
   ...
   `(show-paren-mismatch-face ((,class (:background orange :foreground "white"))))
   ...
   `(eldoc-highlight-function-argument ((,class (:foreground ,purple :weight bold))))
   ...
   ;; `(diredp-dir-heading ((,class (:foreground ,green :weight bold))))
    `(diredp-dir-heading ((,class (:foreground ,"#FF9800" :weight bold))))
   ...
   `(magit-blame-heading          ((t (:background ,background
                                       :foreground ,aqua))))
   `(magit-blame-date             ((t (:background ,background
                                                   :foreground ,"#80cbc4"))))
   `(magit-blame-summary          ((t (:background ,background
                                       :foreground ,green))))
   `(magit-diff-context-highlight      ((t (:background ,background
                                            :foreground "grey70"))))
   ...
   `(helm-ff-file ((,class (:foreground ,foreground :background ,background))))
   `(helm-ff-directory ((,class (:foreground ,aqua ))))
   `(helm-ff-executable ((,class (:foreground ,green ))))
   `(helm-buffer-directory ((,class (:foreground ,aqua))))
   `(helm-buffer-file ((,class (:foreground ,foreground :background ,background))))
   ...
   `(org-table ((,class (:foreground ,"#e3f2fd" :background ,background))))
   ...
   `(js3-external-variable-face ((,class (:foreground ,"#263238"))))
   ...
   `(company-tooltip ((,class (:weight bold :foreground, background :background ,inactive-gray))))
   ...
   ;; erc-colorize
   `(erc-distinct-1-face ((,class (:foreground , orange))))
   `(erc-distinct-2-face ((,class (:foreground , red))))
   `(erc-distinct-3-face ((,class (:foreground , aqua))))
   `(erc-distinct-4-face ((,class (:foreground , purple))))
   `(erc-distinct-5-face ((,class (:foreground , orange))))
   `(erc-distinct-6-face ((,class (:foreground ,"#51b7ae"))))
  ...
  (custom-theme-set-variables
   ...
   ;; highlight-sexp-mode
   `(hl-sexp-background-color ,background)
...
;;; material-sublime-theme.el ends here
